...
let cabalPkgs = [
    # { name = "apply-refact"; exe = "refactor"; ver = "0.15.0.0"; }
    { name = "cabal-add"; ver = "0.2"; }
    { name = "cabal-fmt"; ver = "0.1.12"; }
    { name = "doctest"; exe = "cabal-doctest"; ver = "0.24.3"; flags = "-fcabal-doctest"; }
    { name = "ghcid"; ver = "0.8.9"; }
    # { name = "ghci-dap"; ver = "0.0.26.0"; }
